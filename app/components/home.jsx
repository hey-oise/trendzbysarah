...
export default function Header() {
  return (
    <div id="home" className="scroll-mt-20 bg-pink-100 lg:min-h-150 h-120 w-full p-5 lg:p-10 flex flex-row justify-between items-center border-b border-b-gray-800 mt-15">
      <div className="flex flex-col gap-2 justify-center">
        ...
        <div className="mt-5 flex gap-3">
          <button className="text-amber-700 capitalize border border-gray-800 rounded-xl p-3 cursor-pointer hover:bg-amber-300 transition-delay-500 font-bold">learn more</button>

          <button className="text-gray-100 capitalize border border-gray-600 rounded-xl p-3 cursor-pointer bg-green-600 hover:bg-green-700 font-bold">shop now!</button>
        </div>
      </div>
