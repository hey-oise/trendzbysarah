...
export default function Testimonies() {
  ...
  return (
    <>
    <div ref={ref} id="Testimonial" className={`scroll-mt-20 bg-amber-50 py-10 gap-10 min-h-150 w-full p-5 lg:p-10 flex flex-col border-b border-amber-200 pb-10 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
      ...
      {testimonials.map((data) => {
        return (
          ...
          <div className="flex flex-row gap-5 m-auto rotate-0 hover:scale-102 transition-all duration-500">
